...
const ejercicio06 = 'SELECT title,(SELECT AVG(valores) FROM UNNEST(ratings) AS valores) FROM movies';

const ejercicio07 = "SELECT actors FROM movies WHERE movies.year = 2016 AND title LIKE ('%Fast and%')";
